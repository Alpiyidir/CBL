public class Explosion extends CircularObject {
    ...
    Explosion(double posX, double posY, double speed, double radius) {
    ...
    public void updateRadius() {
        ...
        // Increasing exponential decay to simulate radius expansion rate of an explosion
        double radius = finalRadius * (1- Math.exp(-1.8*Math.pow(timeElapsedSinceCreationInSeconds / explosionDurationInSeconds, 0.4)));
